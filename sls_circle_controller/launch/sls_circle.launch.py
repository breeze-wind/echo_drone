...
def generate_launch_description():
    ...
    override_names = [
        ...
        'status_topic',
        'nav_goal_topic',
        'nav_velocity_setpoint_topic',
        'publish_sls_goal_control_active',
        'sls_goal_control_topic',
        'control_rate',
        'use_velocity_topic',
        ...
        'angular_velocity',
        'circle_loops',
        'nav_goal_stale_timeout',
        'nav_goal_velocity_lookahead',
        'nav_goal_max_speed_xy',
        'nav_goal_max_speed_z',
        'nav_goal_tolerance',
        'mav_mass',
        'load_mass',
        'cable_length',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('nav_goal_topic', default_value='/sls_circle/nav_goal'),
        DeclareLaunchArgument(
            'nav_velocity_setpoint_topic',
            default_value='/sls_circle/nav_velocity_setpoint',
        ),
        DeclareLaunchArgument(
            'publish_sls_goal_control_active', default_value='false',
            description='true 时 SLS 在最终目标有效期间激活 MAVROS adapter 的速度源。'),
        DeclareLaunchArgument(
            'sls_goal_control_topic', default_value='/robot/sls_goal_control_active',
            description='MAVROS adapter 的 SLS 速度源选择话题。'),
        DeclareLaunchArgument(
            'control_rate',
            default_value='100.0',
        ...
        DeclareLaunchArgument(
            ...
            description='circle_only、takeoff_then_circle、takeoff_then_hold 或 nav_goal_velocity。',
        ),
        DeclareLaunchArgument(
            'controller_mode',
            default_value='qsf',
        ...
        DeclareLaunchArgument('nav_goal_stale_timeout', default_value='1.0'),
        DeclareLaunchArgument('nav_goal_velocity_lookahead', default_value='0.4'),
        DeclareLaunchArgument('nav_goal_max_speed_xy', default_value='1.0'),
        DeclareLaunchArgument('nav_goal_max_speed_z', default_value='0.5'),
        DeclareLaunchArgument('nav_goal_tolerance', default_value='0.10'),
