...
class GazeboMavrosBridge(Node):
    ...
    def _read_parameters(self):
        for name in [
            ...
            'wind_actual_topic', 'frame_id', 'mass', 'gravity',
            'hover_thrust', 'max_force', 'state_rate', 'enable_wind',
            'wind_force_x', 'wind_force_y', 'wind_force_z',
            'wind_turbulence', 'wind_change_rate',
    ...
    def _apply_cli_parameter_overrides(self):
        ...
        float_names = {
            'mass', 'max_force', 'state_rate', 'wind_force_x', 'wind_force_y',
